...
const utils = require('./utils-ed88f968.js');
...
const CalciteColor = class {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS.container }, index.h("canvas", { class: {
      ...
      } }, intlHex), index.h("calcite-color-hex-input", { allowEmpty: allowEmpty, class: CSS.control, dir: elementDir, onCalciteColorHexInputChange: this.handleHexInputChange, ref: this.storeHexInputRef, scale: hexInputScale, theme: theme, value: selectedColorInHex }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
        [CSS.colorModeContainer]: true,
        [CSS.splitSection]: true
      }, dir: elementDir }, index.h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (index.h("div", { class: { [CSS.savedColorsSection]: true, [CSS.section]: true } }, index.h("div", { class: CSS.header }, index.h("label", null, intlSaved), index.h("div", { class: CSS.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS.deleteColor, color: "dark", disabled: noColor, iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), index.h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS.saveColor, color: "dark", disabled: noColor, iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (index.h("div", { class: CSS.savedColors }, [
...
const CalciteColorHexInput = class {
  ...
  render() {
    ...
    const elementDir = dom.getElementDir(el);
    return (index.h("div", { class: CSS$1.container }, index.h("calcite-input", { "aria-label": intlHex, class: CSS$1.input, dir: elementDir, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, onKeyDown: this.onInputKeyDown, prefixText: "#", ref: this.storeInputRef, scale: "s", value: hexInputValue }), hexInputValue ? (index.h("calcite-color-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: "s" })) : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
